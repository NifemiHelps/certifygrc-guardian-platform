  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-start">
        <div>
          <h1 className="text-3xl font-bold text-foreground">9. Performance Evaluation</h1>
          <p className="text-muted-foreground mt-1">ISO 27001 Performance Evaluation Assessment</p>
        </div>
        <Button 
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-xl">9. Performance Evaluation Assessment</CardTitle>
        </CardHeader>
        <CardContent>
